...
<head>
	...
	<link href="/doit/admin/css/article/add_article.css" rel="stylesheet" type="text/css" />
...
<body class="page-header-fixed">
	...
	<script src="/doit/admin/js/article/add_article.js" type="text/javascript"></script> 
