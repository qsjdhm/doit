...
<head>
	...
	<link href="/doit/admin/upload/css/uploadify.css" type="text/css" rel="stylesheet"/>
	
	<link href="/doit/admin/css/book/add_book.css" rel="stylesheet" type="text/css" />
...
<body class="page-header-fixed">
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li><a href="/doit/bookAction/addPage">添加图书 </a></li>
						...
						<div class="span12">
							<div class="portlet box blue">
								<div class="portlet-title">
									<div class="caption"><i class="icon-edit"></i>添加图书</div>
									<div class="tools">
	...
	<script src="/doit/admin/upload/scripts/swfobject.js" type="text/javascript"></script>
	<script src="/doit/admin/upload/scripts/jquery.uploadify.min.js" type="text/javascript"></script>
	
	<script src="/doit/admin/js/book/add_book.js" type="text/javascript"></script> 
