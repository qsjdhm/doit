...
<head>
	...
	<link href="/doit/admin/css/link/add_link.css" rel="stylesheet" type="text/css" />
...
<body class="page-header-fixed">
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li><a href="/doit/linkAction/addPage">添加外部链接 </a></li>
						...
						<div class="span12">
							<div class="portlet box blue">
								<div class="portlet-title">
									<div class="caption"><i class="icon-edit"></i>添加外部链接</div>
									<div class="tools">
								...
								<div class="portlet-body">
									<form action="#" style="margin-top:30px;" class="form-horizontal">
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" id="linkName" placeholder="" class="m-wrap medium" />
											</div>
										</div>
										<div class="control-group">
											<label class="control-label">链接URL</label>
											<div class="controls">
												<input  id="linkUrl" type="text" placeholder="" class="m-wrap medium" />
											</div>
										</div>
	...
	<script src="/doit/admin/js/link/add_link.js" type="text/javascript"></script> 
