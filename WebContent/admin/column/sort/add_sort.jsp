...
<head>
	...
	<link href="/doit/admin/css/sort/add_sort.css" rel="stylesheet" type="text/css" />
...
<body class="page-header-fixed">
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li><a href="/doit/sortAction/addPage">添加分类 </a></li>
						...
						<div class="span12">
							<div class="portlet box blue">
								<div class="portlet-title">
									<div class="caption"><i class="icon-edit"></i>添加分类</div>
									<div class="tools">
								...
								<div class="portlet-body">
									<form action="#" style="margin-top:30px;"  class="form-horizontal">
										<div class="control-group">
											...
											<div class="controls">
												<select  id="fSortType" class="medium m-wrap" tabindex="1">
													${fSortHtml}
												</select>
											</div>
										</div>
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" id="sortName" placeholder="" class="m-wrap medium" />
											</div>
										</div>
	...
	<script src="/doit/admin/js/sort/add_sort.js" type="text/javascript"></script> 
