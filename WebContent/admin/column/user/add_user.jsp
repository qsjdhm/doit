...
<head>
	...
	<link href="/doit/admin/css/user/add_user.css" rel="stylesheet" type="text/css" />
...
<body class="page-header-fixed">
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li><a href="/doit/userAction/addPage">添加用户 </a></li>
						...
						<div class="span12">
							<div class="portlet box blue">
								<div class="portlet-title">
									<div class="caption"><i class="icon-edit"></i>添加用户</div>
									<div class="tools">
								...
								<div class="portlet-body">
									<form action="#" style="margin-top:30px;" class="form-horizontal">
										<div class="control-group">
											<label class="control-label">用户名称</label>
											<div class="controls">
												<input  id="userName" type="text" placeholder="" class="m-wrap medium" />
											</div>
										</div>
										<div class="control-group">
											<label class="control-label">用户密码</label>
											<div class="controls">
												<input  id="userPassword" type="text" placeholder="" class="m-wrap medium" />
											</div>
										</div>
										<div class="control-group">
											<label class="control-label">用户邮箱</label>
											<div class="controls">
												<input  id="userEmail" type="text" placeholder="" class="m-wrap medium" />
											</div>
										</div>
										<div style="margin-top:150px;" class="form-actions">
											<button id="submit" type="button" class="btn blue"><i class="icon-ok"></i> 保存</button>
	...
	<script src="/doit/admin/js/user/add_user.js" type="text/javascript"></script> 
