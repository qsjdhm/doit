...
// 初始化
function _init(self, url, method, body, errorInfo, callback) {
    fetch(url, {
        method: method,
        credentials: "include",
        headers: {
...
var fetchComponent = {
    ...
    send : function(self, url, method, body, errInfo, callback) {
        return _init(self, url, method, body, errInfo, callback);
    }
};
