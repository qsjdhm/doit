...
<head>
	...
	<link rel="stylesheet" href="/doit/css/front.css" type="text/css" />
</head>
<body>
				...
				<div class="container">
					...
					<nav class="collapse navbar-collapse bs-navbar-collapse" role="navigation">
						<ul class="nav navbar-nav">
							...
							<li><a href="/doit/front/0/front" style="color:#FF8322;padding:0 23px;">前端</a></li>
	...
	<script type="text/javascript" src="/doit/js/front.js"></script>
