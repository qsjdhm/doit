...
<head>
	...
	<link rel="stylesheet" href="/doit/css/java.css" type="text/css" />
</head>
<body>
					...
					<nav class="collapse navbar-collapse bs-navbar-collapse" role="navigation">
						<ul class="nav navbar-nav">
							...
							<li><a href="/doit/front/0/front">前端</a></li>
				      		<li><a href="/doit/java/0/java" style="color:#FF8322;padding:0 23px;">JAVA</a></li>
	...
	<script type="text/javascript" src="/doit/js/java.js"></script>
