...
<head>
	...
	<link rel="stylesheet" href="/doit/css/me.css" type="text/css" />
</head>
<body>
					...
					<nav class="collapse navbar-collapse bs-navbar-collapse" role="navigation">
						<ul class="nav navbar-nav">
							...
							<li><a href="/doit/front/0/front">前端</a></li>
				      		...
				      		<li><a href="/doit/me" style="color:#FF8322;padding:0 23px;">关于我</a></li>
						</ul>
					</nav>
				</div>
			</header>
	...
	<script type="text/javascript" src="/doit/plugins/tip/glimpse.min.js"></script>
	<script type="text/javascript" src="/doit/plugins/tip/glimpse.toastr.js"></script>
	<script type="text/javascript" src="/doit/js/me.js"></script>
