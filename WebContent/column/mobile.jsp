...
<head>
	...
	<link rel="stylesheet" href="/doit/css/mobile.css" type="text/css" />
</head>
<body>
					...
					<nav class="collapse navbar-collapse bs-navbar-collapse" role="navigation">
						<ul class="nav navbar-nav">
							...
							<li><a href="/doit/front/0/front">前端</a></li>
				      		...
				      		<li><a href="/doit/mobile/0/mobile" style="color:#FF8322;padding:0 23px;">移动端</a></li>
		...
		<div class="row">
			...
			<div class="col-md-4 newLeftDiv">
				...
				<div class="ui segment ">
				  	...
				  	<h3 class="ui right floated header"><a style="color:#333;" href="/doit/more/0/more">更多</a></h3>
				...
				<div class="ui segment">
				  	...
				  	<h3 class="ui right floated header"><a style="color:#333;" href="/doit/note/${noteFirstSortID}/0/note">更多</a></h3>
				  	<div class="ui clearing divider"></div>
				...
				<div class="ui segment">
				  	...
				  	<h3 class="ui right floated header"><a style="color:#333;" href="/doit/book/3/0/book">更多</a></h3>
				  	<div class="ui clearing divider"></div>
	...
	<script type="text/javascript" src="/doit/plugins/jquery.pagination-master/js/jquery.pagination.js"></script>
	...
	<script type="text/javascript" src="/doit/js/mobile.js"></script>
