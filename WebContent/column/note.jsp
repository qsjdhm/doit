...
<head>
	...
	<link rel="stylesheet" href="/doit/css/note.css" type="text/css" />
</head>
<body>
					...
					<nav class="collapse navbar-collapse bs-navbar-collapse" role="navigation">
						<ul class="nav navbar-nav">
							...
							<li><a href="/doit/front/0/front">前端</a></li>
				      		...
				      		<li><a href="/doit/note/${firstSortID}/0/note" style="color:#FF8322;padding:0 23px;">笔记</a></li>
	...
	<script type="text/javascript" src="/doit/js/note.js"></script>
