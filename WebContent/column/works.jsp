...
<head>
	...
	<link rel="stylesheet" href="/doit/css/works.css" type="text/css" />
</head>
<body>
					...
					<nav class="collapse navbar-collapse bs-navbar-collapse" role="navigation">
						<ul class="nav navbar-nav">
							...
							<li><a href="/doit/front/0/front">前端</a></li>
				      		...
				      		<li><a href="/doit/works/0/works" style="color:#FF8322;padding:0 23px;">个人作品</a></li>
	...
	<script type="text/javascript" src="/doit/js/works.js"></script>
